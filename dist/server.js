...
async function main() {
  ...
  server.registerTool(
    "inspect_attachment",
    {
      ...
      inputSchema: z2.object({
        path: z2.string().min(1).describe("Codex \u5F53\u524D\u5BF9\u8BDD\u9644\u4EF6\u660E\u786E\u63D0\u4F9B\u7684\u7EDD\u5BF9\u672C\u5730\u8DEF\u5F84\uFF1B\u8C03\u7528\u524D\u5FC5\u987B\u7531\u5BBF\u4E3B\u5411\u7528\u6237\u663E\u793A\u5DE5\u5177\u5BA1\u6279")
      }),
      outputSchema: inspectedOutputSchema,
      annotations: { readOnlyHint: true, destructiveHint: false, idempotentHint: false, openWorldHint: false }
    },
    async ({ path: path5 }) => executeTool(() => attachments.inspect(path5))
  );
  server.registerTool(
    "prepare_attachment",
    {
      ...
      inputSchema: z2.object({
        attachment_handle: z2.string().min(1).describe("inspect_attachment \u8FD4\u56DE\u7684\u4E00\u6B21\u6027\u68C0\u67E5\u53E5\u67C4")
      }),
  ...
  server.registerTool(
    ...
    async ({ estimation_contract_version, pricing, preset, preset_price_behavior, output_count, confirmation_thresholds }) => executeTool(() => estimateGenerationCredits({
  ...
  server.registerTool(
    ...
    async ({ estimation_contract_version, pricing, preset, preset_price_behavior, person_count, output_count_per_person, confirmation_thresholds }) => executeTool(() => estimateGenerationCredits({
      estimation_contract_version,
      pricing,
      preset,
      preset_price_behavior,
  ...
  server.registerTool(
    ...
    async ({ estimation_contract_version, pricing, input_count, confirmation_thresholds }) => executeTool(() => estimateGenerationCredits({
      estimation_contract_version,
      pricing,
  ...
  server.registerTool(
    ...
    async ({ estimation_contract_version, pricing, output_duration_seconds, input_video_duration_seconds, confirmation_thresholds }) => executeTool(() => estimateGenerationCredits({
      estimation_contract_version,
      pricing,
      measurements: {
        output_duration_seconds,
  ...
  server.registerTool(
    "upload_staged_attachment",
    {
      ...
      inputSchema: z2.object({
        staged_handle: z2.string().describe("prepare_attachment \u8FD4\u56DE\u7684\u4E00\u6B21\u6027\u6682\u5B58\u53E5\u67C4"),
        direct_upload: directUploadSchema.describe("create_direct_upload \u8FD4\u56DE\u7684\u5B8C\u6574\u76F4\u4F20\u4FE1\u606F\uFF0C\u4E0D\u5F97\u624B\u5DE5\u4FEE\u6539")
      }),
      outputSchema: z2.object({ asset_id: z2.string() }),
      annotations: { readOnlyHint: false, destructiveHint: false, idempotentHint: false, openWorldHint: true }
    },
    async ({ staged_handle, direct_upload }) => executeTool(() => attachments.upload(staged_handle, direct_upload))
  );
